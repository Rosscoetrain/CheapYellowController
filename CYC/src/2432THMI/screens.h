...
typedef struct _objects_t {
    ...
    lv_obj_t *credits;
    lv_obj_t *info;
    lv_obj_t *accessories_1;
    lv_obj_t *accessories_2;
    lv_obj_t *btn_stop;
    lv_obj_t *btn_power;
    lv_obj_t *sw_dir;
    ...
    lv_obj_t *acc0_10;
    lv_obj_t *acc0_11;
    lv_obj_t *info_button_11;
    lv_obj_t *obj58;
    lv_obj_t *credits_button_11;
    lv_obj_t *obj59;
    lv_obj_t *obj60;
    lv_obj_t *acc0_12;
    lv_obj_t *acc0_13;
...
enum ScreensEnum {
    ...
    SCREEN_ID_INFO = 12,
    SCREEN_ID_ACCESSORIES_1 = 13,
    SCREEN_ID_ACCESSORIES_2 = 14,
};
