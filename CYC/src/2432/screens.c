...
void create_screen_edit_acc() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_img_src(obj, &img_lh0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_lh1, LV_PART_MAIN | LV_STATE_CHECKED);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 10, 100);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_lh0);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 50, 100);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_rh0);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 11, 145);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_ds0);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 51, 145);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_ds2);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 93, 146);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_ds1);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 133, 146);
            lv_obj_set_size(obj, 32, 32);
            lv_img_set_src(obj, &img_ds3);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            ...
            lv_obj_set_size(obj, 32, 32);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CHECKABLE|LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_bg_img_src(obj, &img_dsu0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_dsu1, LV_PART_MAIN | LV_STATE_CHECKED);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            ...
            lv_obj_set_size(obj, 32, 32);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CHECKABLE|LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_bg_img_src(obj, &img_dsl0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_dsl1, LV_PART_MAIN | LV_STATE_CHECKED);
        }
    }
...
void create_screen_accessories() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 70, 30);
            lv_obj_add_event_cb(obj, action_accessories_button, LV_EVENT_RELEASED, (void *)26);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SNAPPABLE);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_dir(obj, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            // CreditsButton_11
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.credits_button_11 = obj;
            lv_obj_set_pos(obj, 164, 250);
            lv_obj_set_size(obj, 70, 30);
            lv_obj_add_event_cb(obj, action_accessories_button, LV_EVENT_RELEASED, (void *)27);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SNAPPABLE);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_dir(obj, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_credits() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "The \"CYC\" acronym is a credit to the originator of the CYD (Cheap Yellow Display). ");
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
